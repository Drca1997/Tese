...
public interface ISetup
{
    ...
    Grid SetupGrid(System.Random prng, int width, int height);
...
public interface IUpdate
{
    ...
    void UpdateGrid(Grid g, System.Random prng, float delay, bool debug);
...
{
    List<int>[,] GenerateMap(System.Random prng, int width, int height);
}

public interface IWFC
{
    bool WFC(int[,] input_grid, int[,] output_grid, int pattern_size, bool nLoop, bool includeInput, Vector2Int inputStart, bool WFCRotate90, bool WFCRotate180, bool WFCRotate270, bool WFCFlipVert, bool WFCFlipHor);
}